      ...
      <div className="container mx-auto px-4 py-8">
        ...
        {showForm && (
          <div className="mb-8 bg-white p-6 rounded-lg shadow-lg">
            <h3 className="headtext text-black mb-4">
              {editingLocation ? "Edit Location" : "Add New Location"}
            </h3>
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                <label className="block subtext text-gray-700 mb-1">
                  Location Name *
                </label>
                <input
                  type="text"
              ...
              <div>
                ...
                <textarea
                  ...
                  required
                  rows="3"
                  className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-sky-500 focus:border-sky-500 resize-none"
                />
              </div>
        ...
        {!loading && (
          <div className="bg-white rounded-lg shadow-lg overflow-hidden">
            <div className="px-6 py-4 bg-gray-50">
              <h2 className="headtext text-black">Manage Locations</h2>
            </div>
            <div className="p-6">
              {locations.length === 0 ? (
                <div className="text-center py-8">
                  <div className="text-4xl mb-4">🏝️</div>
                  <h3 className="headtext text-gray-600 mb-2">
                    No locations yet
                  </h3>
                  ...
                  {locations.map((location) => (
                    ...
                    >
                      <div className="flex-1">
                        <h4 className="subtext font-semibold text-black mb-1">
                          {location.name}
                        </h4>
